      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="absolute z-50 right-4 bottom-4 md:right-6 md:bottom-6 bg-[#0a0a0a] border border-orange-500/30 text-white rounded-full px-5 py-3 shadow-[0_0_20px_rgba(249,115,22,0.2)] flex items-center gap-3 transition-colors hover:border-orange-500/60 hover:shadow-[0_0_30px_rgba(249,115,22,0.4)]"
          >
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="flex items-center p-4 border-b border-white/10 relative">
                  <Search
                    size={22}
                    className="text-orange-500 absolute left-6"
                  />
                  <input
                    ref={inputRef}
                    type="text"
                ...
                <div className="px-6 py-3 bg-black/40 border-t border-white/5 flex justify-between items-center text-[10px] text-gray-500 uppercase tracking-widest">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="hidden sm:inline-flex items-center gap-1">
                      <span className="border border-gray-600 rounded px-1 py-0.5">
                        ↑
                      </span>
                      <span className="border border-gray-600 rounded px-1 py-0.5">
                        ↓
